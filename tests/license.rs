...
mod tests {
    ...
    fn test_valid_license_should_pass() {
        let result = validate_license(
            "tests/assets/sigil_license_valid.toml",
            "test-runtime",
            "test-fp",
        );
        assert!(result.is_ok());
    ...
    fn test_expired_license_should_fail() {
        let result = validate_license(
            "tests/assets/sigil_license_expired.toml",
            "test-runtime",
            "test-fp",
        )
        .unwrap();
    ...
    fn test_mismatched_runtime_should_score_0_2() {
        let result = validate_license(
            "tests/assets/sigil_license_bad_runtime.toml",
            "test-runtime",
            "test-fp",
        )
        .unwrap();
    ...
    fn test_mismatched_fingerprint_should_score_0_4() {
        let result = validate_license(
            "tests/assets/sigil_license_bad_fp.toml",
            "test-runtime",
            "test-fp",
        )
        .unwrap();
    ...
    fn test_unsealed_license_should_score_0_5() {
        let result = validate_license(
            "tests/assets/sigil_license_unsealed.toml",
            "test-runtime",
            "test-fp",
        )
        .unwrap();
    ...
    fn test_missing_license_block_should_error() {
        let result = validate_license(
            "tests/assets/sigil_license_missing_header.toml",
            "test-runtime",
            "test-fp",
        );
    ...
    fn test_invalid_syntax_should_error() {
        let result = validate_license(
            "tests/assets/sigil_license_invalid_syntax.toml",
            "test-runtime",
            "test-fp",
        );
        assert!(result.is_err());
